Shader "Custom/StarGateExperiment1.5"
{
    Properties
    {
        ...
        _Amount ("Amount", Range(1, 20)) = 1.0               // Amount of Noise
        }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                // --- NOISE MIXING CHANGED!
                float4 finalcol = col * col2;
                ...
                finalcol.rgb = (clamp(finalcol.rgb - finalFade , 0, 1) * noiseColor.rgb) * _EmissionStrength;
