Shader "Unlit/StarGateGradientEmission" {
    
    // Shader Variant that changes the way the Gradient is applied to the StarGate Noise
    // Also adds Distance Emission
    // Used for the Quasar
    Properties {
    ...
    SubShader {
        ...
        Pass {        
            Blend SrcAlpha OneMinusSrcAlpha // Traditional Transaprency
            Cull Off // No Culling
            ZWrite Off // No ZWrite
            ColorMask RGB 
            ...
            #include "UnityCG.cginc" // Unity Shader Helper Functions
            ...
            half4 frag(v2f i) : SV_Target {
                ...
                col.rgb = (clamp(col.rgb - vFade, 0, 1) * noiseColor.rgb) * emissionStrengthfar;
